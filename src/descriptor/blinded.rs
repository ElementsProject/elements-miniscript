...
use super::{
    ...
    Descriptor, DescriptorTrait, ElementsTrait, PkTranslate,
};
    ...
    <<Pk as MiniscriptKey>::Hash as FromStr>::Err: ToString,
{
    ...
    {
        self.desc.blind_addr(to_pk_ctx, blinder, params)
    }
}
    ...
    <<Pk as MiniscriptKey>::Hash as FromStr>::Err: ToString,
{
    ...
    where
        Pk: ToPublicKey<ToPkCtx>,
    {
        self.desc.blind_addr(
            to_pk_ctx,
            Some(self.blinder.to_public_key(to_pk_ctx).key),
            params,
        )
    }
    ...
    where
        Pk: ToPublicKey<ToPkCtx>,
    {
        self.desc.script_pubkey(to_pk_ctx)
    }
    ...
    where
        Pk: ToPublicKey<ToPkCtx>,
    {
        self.desc.unsigned_script_sig(to_pk_ctx)
    }
    ...
    where
        Pk: ToPublicKey<ToPkCtx>,
    {
        self.desc.witness_script(to_pk_ctx)
    }
    ...
    {
        self.desc.get_satisfaction(satisfier, to_pk_ctx)
    }
...
impl<P: MiniscriptKey, Q: MiniscriptKey> PkTranslate<P, Q> for Blinded<P> {
