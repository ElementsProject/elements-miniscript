            ...
            Some(NonTerm::Expression) => {
                match_token!(
                    ...
                    Tk::Equal => match_token!(
                        ...
                        Tk::Push(_bytes), Tk::Pick, Tk::Sub, Tk::Depth => match_token!(
                            tokens,
                            Tk::Num(12) => term.reduce0(Terminal::Version(4))?, // find some implementation u32 from le
                        ),
                        // thresholds
                        Tk::Num(k) => {
