...
use crate::{descriptor, util, DescriptorPublicKey, DescriptorTrait};
...
impl PsbtExt for Psbt {
    ...
    fn update_desc(
        ...
        let inp = &mut self.inputs_mut()[input_index];
        ...
        match derived_desc {
            ...
            Descriptor::Cov(ref _cov) => {
                // Covenant descriptors already have necessary information stored in unsigned tx
            }
        };
        Ok(())
    }
